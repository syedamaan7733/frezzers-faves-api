    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: token_models_1.TokenLog.name, schema: token_models_1.TokenLogSchma },
            ]),
        ...
        providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, token_models_1.TokenLogService],
